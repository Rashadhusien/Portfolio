...
function App() {
  ...
  return (
    <>
      <div
        id="up"
        className="main-container w-auto relative z-10 md:w-[85%] overflow-hidden bg-seconderylight dark:bg-secondery border-2 border-borderlight dark:border-border container  mx-auto px-4 sm:px-16  "
      >
        <div
